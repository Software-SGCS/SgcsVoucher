...
#End Region
    ...
    Public Sub BindTheGrid()
        ...
        Dim cmdCustomers As SqlCommand = New SqlCommand("Select id,Com_No,Com_Nam,Com_Add1,Com_Email,Com_Per,Com_Pvno From Company order by Com_No,Com_Nam", CON)
    ...
    Private Sub Imagebutton1_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        ADA = New SqlDataAdapter("SELECT * FROM Company WHERE Com_No = '" & Trim(TxtConCode.Text) & "'", CON)
        DS1 = New DataSet
        ...
        If count1 <> 0 Then
            ...
            For Each Me.drt2 In DS1.Tables("Company").Rows
    ...
    Private Sub Save11_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles Save11.Click
        ...
        If count1 <> 0 Then
            ...
            CMD.Connection = CON
            CMD.CommandText = ("UPDATE Company SET Com_No='" & Trim(TxtConCode.Text) & "',Com_Nam='" & Trim(TxtConNam.Text) & "',Com_Add1= '" & Trim(TxtConAdd1.Text) & "',Com_Email= '" & Trim(TxtCusEmail.Text) & "',Com_Per= '" & Trim(TxtContact.Text) & "',Com_Pvno= '" & Trim(TxtRegNo.Text) & "' WHERE Com_No='" & Trim(TxtConCode.Text) & "'")
            CMD.ExecuteNonQuery()

        Else

            CMD.Connection = CON
            CMD.CommandText = ("INSERT INTO Company(Com_No,Com_Nam,Com_Add1,Com_Email,Com_Per,Com_Pvno) VALUES ('" & Trim(TxtConCode.Text) & "','" & Trim(TxtConNam.Text) & "','" & Trim(TxtConAdd1.Text) & "','" & Trim(TxtCusEmail.Text) & "','" & Trim(TxtContact.Text) & "','" & Trim(TxtRegNo.Text) & "')")
            CMD.ExecuteNonQuery()
        End If
    ...
    Protected Sub MyDataGrid_RowCommand(ByVal sender As Object, ByVal e As GridViewCommandEventArgs) Handles MyDataGrid.RowCommand
        ...
        If e.CommandName = "Delete" Then
            ...
            Dim DeleteCmd As String = "DELETE from Company Where id =" & id
