<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EntryCustomer.aspx.vb" Inherits="SgcsVoucher.EntryCustomer" %>
					...
					<table class="style1" id="table1" style="MARGIN-LEFT: 50px">
						<tr>
							<td class="style36"><asp:label id="Label4" runat="server" Height="24px" 
                                    Width="139px" Font-Size="Small" Font-Names="Calibri">Customer Code(4 Digits)</asp:label></td>
							<td class="style37">
						...
						<tr>
							<td class="style36">
                                ...
                                Nos</asp:label></td>
							<td class="style37"><asp:textbox id="TxtContact" runat="server" Height="20px" Width="432px" Font-Size="X-Small" Font-Names="Calibri"></asp:textbox></td>
							<td class="style7">&nbsp;</td>
						</tr>
						<tr>
							...
							<td class="style37">
								<asp:textbox id="TxtCusEmail" runat="server" Height="20px" Width="432px"></asp:textbox>
						...
						<tr>
							...
							<td class="style39">&nbsp;
								<div>
									<div id="Layer1" style="OVERFLOW: scroll; WIDTH: 711px; HEIGHT: 293px">
    <asp:GridView ID="MyDataGrid" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" 
                                            BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" 
                                            Font-Names="Calibri" Font-Size="Small" Width="697px" 
